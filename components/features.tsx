    ...
    <section className="bg-zinc-50 py-16 md:py-32 dark:bg-transparent">
      <div className="@container mx-auto max-w-5xl px-6">
        <div className="text-center">
          ...
          <p className="mt-4">
            Smart, flexible, and powerful -- everything your need to build your
            second brain.
          </p>
        </div>
        <div className="@min-4xl:max-w-full @min-4xl:grid-cols-3 mx-auto mt-8 grid max-w-sm gap-6 *:text-center md:mt-16">
          <Card className="group bg-background">
            ...
            <CardContent>
              <p className="text-sm">
                Capture ideas instantly with lighning-fast input and
                keywoard-first UX. No friction - just flow.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group bg-background">
            ...
            <CardContent>
              <p className="mt-3 text-sm">
                Your ntoes are private. local-first architecture and optional
